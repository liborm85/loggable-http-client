...
class AmpHttpClientTest extends TestCase
{
    ...
    public function testCancelResponseAfterRequest(): void
    {
        ...
        $this->assertSameResponseContentLog($expected, $logger->logs);
        $this->assertNull($logger->logs[0]['request-time-datetime']);
        $this->assertNull($logger->logs[0]['response-time-datetime']);
    }
    ...
    {
        $client = new LoggableHttpClient(new AmpHttpClient());
